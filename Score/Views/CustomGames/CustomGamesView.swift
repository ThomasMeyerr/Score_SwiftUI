...
struct CustomGamesView: View {
    ...
    var body: some View {
        ...
        .navigationTitle(
            getText(forKey: "customGame", forLanguage: data.languages)
        )
        ...
        .alert(
            ...
            if isPartyFinished {
                ...
                return Alert(
                    title: Text(
                        getText(forKey: "timeUp", forLanguage: data.languages)
                    ),
                    message: Text(
                        getText(
                            forKey: "timeUpMessage",
                            forLanguage: data.languages
                        )
                    ),
                    dismissButton: .default(Text("OK")) {}
